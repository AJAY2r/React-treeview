...
var TreeNode = (function (_React$Component) {
    ...
    },
    {
        ...
        value: function handleCheckbox(e) {
            const isChecked = !this.props.node.checked;
    ...
    },
    {
        ...
        value: function render() {
          var checkboxElement;
          var chkChecked = this.props.node.checked || false;
          // var chkChecked = this.state[this.props.node[this.props.checkboxField]] || false;
